...
if (isset($_POST['submit'])) {    
    $contactName = $_POST['user-name'];    
    $contactEmail = $_POST['user-email'];
    $contactNeed = $_POST['contact-need'];    
    ...
    try {
        ...
        $database->query('insert into home_form (contact_name, contact_email, contact_need) values (:contact_name,:contact_email, :contact_need)');
        $database->bind(':contact_name', $contactName);       
        $database->bind(':contact_email', $contactEmail);
        $database->bind(':contact_need', $contactNeed);        
